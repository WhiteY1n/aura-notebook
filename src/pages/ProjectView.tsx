...
import { ArrowLeft, StickyNote, Moon, Sun } from "lucide-react";
  ...
  return <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            scale: 0.95
              ...
              <Button variant="ghost" size="icon" onClick={() => setTheme(isDark ? "light" : "dark")} className="text-muted-foreground hover:text-foreground">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Browser Tabs */}
          <BrowserTabs sources={sources} activeTab={activeTab} onTabChange={setActiveTab} onCloseTab={handleCloseSource} onAddSource={() => console.log("Add source")} />
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {activeTab === "chat" ? <>
                ...
                y: 0
                    ...
                    </motion.div> : <div className="space-y-4 max-w-3xl mx-auto">
        ...
        <StudioPanel projectId={id || "1"} generatedItems={generatedItems} onDeleteItem={handleDeleteGeneratedItem} />

        {/* Studio Sheet (Mobile) */}
        <StudioSheet projectId={id || "1"} generatedItems={generatedItems} onDeleteItem={handleDeleteGeneratedItem} />
      </div>
    </div>;
}